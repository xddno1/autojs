()
...
for (;;) {
    sleep(1000)
    img = captureScreen()
    var 蓝色开始坐标 = findImage(img, 蓝色开始)
    if (蓝色开始坐标 != null) {
        click(蓝色开始坐标.x, 蓝色开始坐标.y)
        back()
        sleep(1000)
        for (;;) {
            img = captureScreen()
